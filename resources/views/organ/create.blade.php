...
<div class="section-header">
    <h2 class="section-title">Создание организации</h2>
...
<div class="organ-form-container">
    <form action="{{ route('organ.store') }}" method="POST" enctype="multipart/form-data" class="organ-form needs-validation" novalidate>
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="file-input-wrapper">
                ...
                <div class="invalid-feedback">
                    Пожалуйста, загрузите логотип для организации.
                </div>
                @error('logo')
                    <div class="invalid-feedback d-block">
                        {{ $message }}
            ...
            <div class="form-text">Загрузите логотип для организации (JPEG, PNG, GIF, JPG до 2MB)</div>
        </div>
        
        <div class="organ-form-actions">
            <button type="submit" class="btn-primary">
                <i class="fas fa-save"></i> Сохранить организацию
            </button>
        </div>
    </form>
</div>
